            ...
            <form role="form" method="post" enctype="multipart">
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="Text" name="title" value="<?= $news['title'] ?>" class="form-control <?= form_error('title') == TRUE ? 'is-invalid' : ''; ?>" placeholder="Enter Title *">
                  <a style="color: red;"><?= form_error('title') ?></a>
                </div>
                <div class="form-group">
                  <textarea name="content" class="form-control" placeholder="Enter Content"><?= $news['content'] ?></textarea>
                </div>
                <div class="form-group">
