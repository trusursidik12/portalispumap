      ...
      <div class="row">
        ...
        <div class="container">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" action="<?= site_url($controllers.'/add') ?>" method="post" enctype="multipart">
              <div class="card-body">
                <div class="form-group">
                  <input type="Text" name="title" class="form-control <?= form_error('title') == TRUE ? 'is-invalid' : ''; ?>" placeholder="Enter Title *">
