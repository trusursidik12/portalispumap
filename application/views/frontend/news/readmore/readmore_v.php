    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 col-lg-8">
                <img src="<?= base_url() ?>assets/frontend/img/news-img/weather.jpg" style="padding-top: 50px;" alt="">
                <h3 class="mt-30"><b>Title Here Title Here Title Here Title Here Title Here Title Here Title Here </b></h3>
                <ul class="list-li-mr-20 mtb-15">
                    <li>by <b>Ispumap.id,</b> Jan 25, 2018</li>
                </ul>
