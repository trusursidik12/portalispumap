<!-- <section class="section section-lg bg-gradient-animated text-center d-flex align-items-center min-vh-100 novi-background" data-preset='{"title":"Intro","category":"intro","reload":false,"id":"intro-10"}'> -->
          ...
          <div class="row align-items-center slick-creative novi-disabled">
            <div class="col-md-7 d-md-flex flex-md-row-reverse">
              <div class="slick-slider slider-for slider-images" data-slick='{"arrows":false,"vertical":true,"asNavFor":".slider-nav","adaptiveHeight":true}'>
                <div class="text-right"><img src="<?= base_url() ?>assets/frontend/images/header/monas_hd.png" alt="" width="1042" height="910"/>
                </div>
                <div class="text-right"><img src="<?= base_url() ?>assets/frontend/images/header/bali_hd.png" alt="" width="1042" height="910"/>
                </div>
                <div class="text-right"><img src="<?= base_url() ?>assets/frontend/images/header/jogja_hd.png" alt="" width="1042" height="910"/>
                </div>
              </div>
    	 </div>
            <div class="col-md-5 pt-5" style="padding-bottom: 14.2%">
              <div class="pl-xxl-3">
                ...
                <div class="slick-slider slider-for" data-slick='{"arrows":false,"vertical":true,"asNavFor":".slider-nav"}'>
         ...
         <!-- </section> -->
      <!-- Novi-->
      <section class="section section-lg bg-transparent novi-background" id="journey" data-preset='{"title":"Novi Builder","category":"content box","reload":false,"id":"novi-builder-2"}'>
        <div class="container">
          <div class="row row-30 align-items-center justify-content-lg-between">
            ...
            <div class="col-xs-10 col-sm-6 col-md-7"><img class="shadow-lg" src="<?= base_url() ?>assets/frontend/images/image-33-730x456.gif" alt="" width="730" height="456"/>
            </div>
          </div>
        </div>
      </section>
      ...
      <!-- Layouts-->
      <section class="section section-lg bg-gradient-animated novi-background" data-preset='{"title":"Layouts","category":"tab, gallery, thumbnail","reload":true,"id":"layouts"}'>
        <div class="container-fluid">
          <h1 class="text-center" data-animate='{"class":"fadeInUp"}'>
            Check out other themes<br class="d-none d-xs-block">
            based on Intense
          </h1>
          <div class="tab">
            <ul class="nav nav-classic justify-content-center" role="tablist" data-animate='{"class":"fadeInUp"}'>
              <li class="nav-item"><a class="nav-link h4 active" data-toggle="tab" href="#navClassic1-1" role="tab" aria-selected="true">Home Pages</a></li>
              <li class="nav-item"><a class="nav-link h4" data-toggle="tab" href="#navClassic1-2" role="tab" aria-selected="false">Skins</a></li>
            </ul>
            <div class="tab-content">
              <div class="tab-pane fade show active" id="navClassic1-1" role="tabpanel">
                <div class="row row-30 row-md-40 row-lg-50 justify-content-center">
                  <div class="col-xs-6 col-md-4 col-xl-auto" data-animate='{"class":"fadeInUp"}'>
                          <!-- Layout-->
                          <article class="layout"><a class="layout-figure thumbnail-up-shadow" href="index.html"><img src="<?= base_url() ?>assets/frontend/images/layouts/layout-1-336x450.jpg" alt="" width="336" height="450"/></a>
                  ...
                  <div class="col-xs-6 col-md-4 col-xl-auto" data-animate='{"class":"fadeInUp"}'>
                          <!-- Layout-->
                          <article class="layout"><a class="layout-figure thumbnail-up-shadow" href="home-consulting.html"><img src="<?= base_url() ?>assets/frontend/images/layouts/layout-3-336x450.jpg" alt="" width="336" height="450"/></a>
                            <div class="layout-title h6"><a class="layout-title-link" href="home-consulting.html">Home — Consulting</a>
                            </div>
                          </article>
                  </div>
                  <div class="col-xs-6 col-md-4 col-xl-auto" data-animate='{"class":"fadeInUp"}'>
                          <!-- Layout-->
                          <article class="layout"><a class="layout-figure thumbnail-up-shadow" href="home-business.html"><img src="<?= base_url() ?>assets/frontend/images/layouts/layout-2-336x450.jpg" alt="" width="336" height="450"/></a>
                            <div class="layout-title h6"><a class="layout-title-link" href="home-business.html">Home — Business</a>
                            </div>
                          </article>
                  </div>
                  <div class="col-xs-6 col-md-4 col-xl-auto" data-animate='{"class":"fadeInUp"}'>
                          <!-- Layout-->
                          <article class="layout"><a class="layout-figure thumbnail-up-shadow" href="home-studio.html"><img src="<?= base_url() ?>assets/frontend/images/layouts/layout-5-336x450.jpg" alt="" width="336" height="450"/></a>
                            <div class="layout-title h6"><a class="layout-title-link" href="home-studio.html">Home — Studio</a>
                            </div>
                          </article>
                  </div>
                  <div class="col-xs-6 col-md-4 col-xl-auto" data-animate='{"class":"fadeInUp"}'>
                          <!-- Layout-->
                          <article class="layout"><a class="layout-figure thumbnail-up-shadow" href="home-application.html"><img src="<?= base_url() ?>assets/frontend/images/layouts/layout-6-336x450.jpg" alt="" width="336" height="450"/></a>
                            <div class="layout-title h6"><a class="layout-title-link" href="home-application.html">Home — App</a>
                            </div>
                          </article>
                  </div>
                  <div class="col-xs-6 col-md-4 col-xl-auto" data-animate='{"class":"fadeInUp"}'>
                          <!-- Layout-->
                          <article class="layout"><a class="layout-figure thumbnail-up-shadow" href="home-event.html"><img src="<?= base_url() ?>assets/frontend/images/layouts/layout-7-336x450.jpg" alt="" width="336" height="450"/></a>
                            <div class="layout-title h6"><a class="layout-title-link" href="home-event.html">Home — Event</a>
                            </div>
                          </article>
                  </div>
                  <div class="col-xs-6 col-md-4 col-xl-auto" data-animate='{"class":"fadeInUp"}'>
                          <!-- Layout-->
                          <article class="layout"><a class="layout-figure thumbnail-up-shadow" href="home-blog.html"><img src="<?= base_url() ?>assets/frontend/images/layouts/layout-8-336x450.jpg" alt="" width="336" height="450"/></a>
                            <div class="layout-title h6"><a class="layout-title-link" href="home-blog.html">Home — Blog</a>
                            </div>
                          </article>
                  </div>
                  <div class="col-xs-6 col-md-4 col-xl-auto" data-animate='{"class":"fadeInUp"}'>
                          <!-- Layout-->
                          <article class="layout"><a class="layout-figure thumbnail-up-shadow" href="home-store.html"><img src="<?= base_url() ?>assets/frontend/images/layouts/layout-9-336x450.jpg" alt="" width="336" height="450"/></a>
                            <div class="layout-title h6"><a class="layout-title-link" href="home-store.html">Home — Store</a>
                            </div>
                          </article>
                  </div>
                  <div class="col-xs-6 col-md-4 col-xl-auto" data-animate='{"class":"fadeInUp"}'>
                          <!-- Layout-->
                          <article class="layout"><a class="layout-figure thumbnail-up-shadow" href="home-minimal.html"><img src="<?= base_url() ?>assets/frontend/images/layouts/layout-10-336x450.jpg" alt="" width="336" height="450"/></a>
                            <div class="layout-title h6"><a class="layout-title-link" href="home-minimal.html">Home — Minimal</a>
                            </div>
                          </article>
                  </div>
                  <div class="col-xs-6 col-md-4 col-xl-auto" data-animate='{"class":"fadeInUp"}'>
                          <!-- Layout-->
                          <article class="layout"><a class="layout-figure thumbnail-up-shadow" href="home-portfolio.html"><img src="<?= base_url() ?>assets/frontend/images/layouts/layout-4-336x450.jpg" alt="" width="336" height="450"/></a>
                            <div class="layout-title h6"><a class="layout-title-link" href="home-portfolio.html">Home — Portfolio</a>
                            </div>
                          </article>
                  </div>
                </div>
              ...
              <div class="tab-pane fade" id="navClassic1-2" role="tabpanel">
                <div class="row row-40 row-md-50 justify-content-center flex-row-reverse">
                  <div class="col-xs-6 col-md-4 col-xl-auto">
                          <!-- Layout-->
                          <article class="layout"><a class="layout-figure thumbnail-up-shadow" href="index.html"><img src="<?= base_url() ?>assets/frontend/images/layouts/layout-1-336x450.jpg" alt="" width="336" height="450"/></a>
                            <div class="layout-title h6"><a class="layout-title-link" href="index.html">Home — Default</a>
                            </div>
                  ...
                  <div class="col-xs-6 col-md-4 col-xl-auto">
                          <!-- Layout-->
                          <article class="layout layout-disabled"><a class="layout-figure thumbnail-up-shadow" href="#"><img src="<?= base_url() ?>assets/frontend/images/layouts/layout-2-336x450.jpg" alt="" width="336" height="450"/></a>
                            <div class="layout-title h6"><a class="layout-title-link" href="#">Home — Business</a><span class="badge badge-warning ml-2">soon</span>
                            </div>
                          </article>
                  </div>
                  <div class="col-xs-6 col-md-4 col-xl-auto">
                          <!-- Layout-->
                          <article class="layout layout-disabled"><a class="layout-figure thumbnail-up-shadow" href="#"><img src="<?= base_url() ?>assets/frontend/images/layouts/layout-3-336x450.jpg" alt="" width="336" height="450"/></a>
                            <div class="layout-title h6"><a class="layout-title-link" href="#">Home — Consulting</a><span class="badge badge-warning ml-2">soon</span>
                            </div>
                          </article>
                  </div>
                  <div class="col-xs-6 col-md-4 col-xl-auto">
                          <!-- Layout-->
                          <article class="layout layout-disabled"><a class="layout-figure thumbnail-up-shadow" href="#"><img src="<?= base_url() ?>assets/frontend/images/layouts/layout-4-336x450.jpg" alt="" width="336" height="450"/></a>
                            <div class="layout-title h6"><a class="layout-title-link" href="#">Home — Portfolio</a><span class="badge badge-warning ml-2">soon</span>
                            </div>
                          </article>
                  </div>
                  <div class="col-xs-6 col-md-4 col-xl-auto">
                          <!-- Layout-->
                          <article class="layout layout-disabled"><a class="layout-figure thumbnail-up-shadow" href="#"><img src="<?= base_url() ?>assets/frontend/images/layouts/layout-5-336x450.jpg" alt="" width="336" height="450"/></a>
                            <div class="layout-title h6"><a class="layout-title-link" href="#">Home — Studio</a><span class="badge badge-warning ml-2">soon</span>
                            </div>
                          </article>
                  </div>
                  <div class="col-xs-6 col-md-4 col-xl-auto">
                          <!-- Layout-->
                          <article class="layout layout-disabled"><a class="layout-figure thumbnail-up-shadow" href="#"><img src="<?= base_url() ?>assets/frontend/images/layouts/layout-6-336x450.jpg" alt="" width="336" height="450"/></a>
                            <div class="layout-title h6"><a class="layout-title-link" href="#">Home  — App</a><span class="badge badge-warning ml-2">soon</span>
                            </div>
                          </article>
                  </div>
                  <div class="col-xs-6 col-md-4 col-xl-auto">
                          <!-- Layout-->
                          <article class="layout layout-disabled"><a class="layout-figure thumbnail-up-shadow" href="#"><img src="<?= base_url() ?>assets/frontend/images/layouts/layout-7-336x450.jpg" alt="" width="336" height="450"/></a>
                            <div class="layout-title h6"><a class="layout-title-link" href="#">Home — Event</a><span class="badge badge-warning ml-2">soon</span>
                            </div>
                          </article>
                  </div>
                  <div class="col-xs-6 col-md-4 col-xl-auto">
                          <!-- Layout-->
                          <article class="layout layout-disabled"><a class="layout-figure thumbnail-up-shadow" href="#"><img src="<?= base_url() ?>assets/frontend/images/layouts/layout-8-336x450.jpg" alt="" width="336" height="450"/></a>
                            <div class="layout-title h6"><a class="layout-title-link" href="#">Home — Blog</a><span class="badge badge-warning ml-2">soon</span>
                            </div>
                          </article>
                  </div>
                  <div class="col-xs-6 col-md-4 col-xl-auto">
                          <!-- Layout-->
                          <article class="layout layout-disabled"><a class="layout-figure thumbnail-up-shadow" href="#"><img src="<?= base_url() ?>assets/frontend/images/layouts/layout-9-336x450.jpg" alt="" width="336" height="450"/></a>
                            <div class="layout-title h6"><a class="layout-title-link" href="#">Home — Store</a><span class="badge badge-warning ml-2">soon</span>
                            </div>
                          </article>
                  </div>
                  <div class="col-xs-6 col-md-4 col-xl-auto">
                          <!-- Layout-->
                          <article class="layout layout-disabled"><a class="layout-figure thumbnail-up-shadow" href="#"><img src="<?= base_url() ?>assets/frontend/images/layouts/layout-10-336x450.jpg" alt="" width="336" height="450"/></a>
                            <div class="layout-title h6"><a class="layout-title-link" href="#">Home — Minimal</a><span class="badge badge-warning ml-2">soon</span>
                            </div>
                          </article>
                  </div>
                </div>
                ...
                <div class="col-12" id="Design">
                  ...
                  <div class="row row-offset-lg row-30 row-md-50 row-xl-70 justify-content-xl-between">
                    ...
                    <div class="col-xs-6 col-md-6 col-xxl-5" data-animate='{"class":"fadeInUp"}'>
                            <!-- Blurb-->
                            <article class="blurb">
                              <div class="blurb-embed"><span class="blurb-icon ith-font novi-icon"></span></div>
                    ...
                    <div class="col-xs-6 col-md-6 col-xxl-5 align-self-center" data-animate='{"class":"fadeInUp"}'>
                            <!-- Blurb-->
                            <article class="blurb">
                              <div class="blurb-embed"><span class="blurb-icon ith-effect novi-icon"></span></div>
                    ...
                    <div class="col-xs-6 col-md-6 col-xxl-5" data-animate='{"class":"fadeInUp"}'>
                            ...
                            <article class="blurb blurb-boxed blurb-primary">
                              <div class="blurb-embed"><span class="blurb-icon ith-pages novi-icon"></span></div>
                  ...
                  <div class="row row-offset-lg row-30 row-md-50 row-xl-70 justify-content-xl-between">
                    <div class="col-xs-6 col-md-6 col-xxl-5" data-animate='{"class":"fadeInUp"}'>
                            ...
                            <article class="blurb blurb-boxed blurb-dark">
                              <div class="blurb-embed"><span class="blurb-icon ith-devices novi-icon"></span></div>
        ...
        <div class="container">
          <div class="effect effect-tazza">
            ...
            <div class="effect-tazza-item-4">
              <div class="layer" data-depth=".4"><img src="<?= base_url() ?>assets/frontend/images/image-39-639x439.png" alt="" width="639" height="439"/>
              </div>
            </div>
            <div class="effect-tazza-item-5">
              <div class="layer" data-depth=".5"><img src="<?= base_url() ?>assets/frontend/images/image-38-1088x559.png" alt="" width="1088" height="559"/>
              </div>
            </div>
          </div>
        </div>
                        ...
                        <q>Intense is full of great details and very useful tools. The template code is clear and easy-to-edit. Moreover, it  is well-documented and supported.</q>
                            ...
                            <div class="quote-author">
                              <div class="media media-md align-items-center">
                                <div class="media-left"><img class="quote-author-image" src="<?= base_url() ?>assets/frontend/images/persons/person-01-64x64.jpg" alt="" width="64" height="64"/>
                                </div>
                    ...
                    <article class="quote">
                      ...
                      <div class="quote-text h5">
                        <q>It is a great template with everything my website needed. It took me a few hours to figure all out but it was worth the investment.</q>
                            ...
                            <div class="quote-author">
                              <div class="media media-md align-items-center">
                                <div class="media-left"><img class="quote-author-image" src="<?= base_url() ?>assets/frontend/images/persons/person-02-64x64.jpg" alt="" width="64" height="64"/>
                                </div>
                                <div class="media-body">
                    ...
                    <article class="quote">
                      ...
                      <div class="quote-text h5">
                        <q>This template has lots of preconfigured child themes, effects, and components. It is a great choice if you need a customizable website.</q>
                            ...
                            <div class="quote-author">
                              <div class="media media-md align-items-center">
                                <div class="media-left"><img class="quote-author-image" src="<?= base_url() ?>assets/frontend/images/persons/person-03-64x64.jpg" alt="" width="64" height="64"/>
                                </div>
                                <div class="media-body">
      ...
      <!-- Call to action-->
      <section class="section section-lg bg-primary-light text-center text-lg-left novi-background" data-preset='{"title":"Call To Action","category":"call to action","reload":false,"id":"call-to-action-7"}'>
        <div class="container">
      ...
      <!-- Features-->
      <section class="section section-lg bg-transparent novi-background" data-preset='{"title":"Features","category":"blurb, tab","reload":true,"id":"testimonials-3"}'>
        <div class="container">
                  ...
                  <div class="tab-pane fade show active" id="navClassic2-1" role="tabpanel">
                    <div class="row row-30">
                      ...
                      <div class="col-6 col-xs-4 col-md-3 col-lg-4" data-animate='{"class":"fadeInUp"}'>
                              <!-- Blurb small-->
                              <article class="blurb blurb-small">
                                <div class="blurb-embed"><span class="blurb-icon ith-slider novi-icon"></span></div>
                      ...
                      <div class="col-6 col-xs-4 col-md-3 col-lg-4" data-animate='{"class":"fadeInUp"}'>
                              <!-- Blurb small-->
                              <article class="blurb blurb-small">
                                <div class="blurb-embed"><span class="blurb-icon ith-parallax novi-icon"></span></div>
                      ...
                      <div class="col-6 col-xs-4 col-md-3 col-lg-4" data-animate='{"class":"fadeInUp"}'>
                              <!-- Blurb small-->
                              <article class="blurb blurb-small">
                                <div class="blurb-embed"><span class="blurb-icon ith-layout-footer novi-icon"></span></div>
                      ...
                      <div class="col-6 col-xs-4 col-md-3 col-lg-4" data-animate='{"class":"fadeInUp"}'>
                              <!-- Blurb small-->
                              <article class="blurb blurb-small">
                                <div class="blurb-embed"><span class="blurb-icon ith-smile novi-icon"></span></div>
                      ...
                      <div class="col-6 col-xs-4 col-md-3 col-lg-4" data-animate='{"class":"fadeInUp"}'>
                              <!-- Blurb small-->
                              <article class="blurb blurb-small">
                                <div class="blurb-embed"><span class="blurb-icon ith-video novi-icon"></span></div>
                      ...
                      <div class="col-6 col-xs-4 col-md-3 col-lg-4" data-animate='{"class":"fadeInUp"}'>
                              <!-- Blurb small-->
                              <article class="blurb blurb-small">
                                <div class="blurb-embed"><span class="blurb-icon ith-layout novi-icon"></span></div>
      ...
      <!-- Child themes-->
      <section class="section section-lg bg-transparent novi-background" data-preset='{"title":"Child Themes","category":"content box","reload":true,"id":"child-themes"}'>
        <div class="container">
          <div class="row row-15 align-items-center flex-md-row-reverse">
            <div class="col-sm-6 col-md-5" data-animate='{"class":"fadeInRight"}'>
              ...
              <h1>A wide variety of child themes for your website</h1>
              <p>Choose from a variety of Child themes and use any of them for your website.</p>
            </div>
            <div class="col-sm-6 col-md-7" data-animate='{"class":"fadeInLeft"}'><img src="<?= base_url() ?>assets/frontend/images/image-37-690x730.png" alt="" width="690" height="730"/>
            </div>
          </div>
        </div>
      </section>